...
const SocialLinks = () => {
  return (
    <ul className="mt-6 flex justify-center space-x-4">
      {socialLinksData.map(({ href, label, path }) => (
        <li key={label}>
          <a href={href} target="_blank" rel="noopener noreferrer" className="text-biru-1">
...
const socialLinksData = [
  {
    label: 'Facebook',
    href: 'http://facebook.com/iyan.scout',
    path: (
  ...
  {
    label: 'Instagram',
    href: 'http://instagram.com/iyan_saputraaa',
    path: (
